...
NOMOS_GCR := gcr.io/$(GCR_PREFIX)/$(NOMOS_IMAGE)
RECONCILER_GCR := gcr.io/$(GCR_PREFIX)/$(RECONCILER_IMAGE)
RECONCILER_MANAGER_GCR := gcr.io/$(GCR_PREFIX)/$(RECONCILER_MANAGER_IMAGE)
ADMISSION_WEBHOOK_GCR := gcr.io/$(GCR_PREFIX)/$(ADMISSION_WEBHOOK_IMAGE)
HYDRATION_CONTROLLER_GCR := gcr.io/$(GCR_PREFIX)/$(HYDRATION_CONTROLLER_IMAGE)
HYDRATION_CONTROLLER_WITH_SHELL_GCR := gcr.io/$(GCR_PREFIX)/$(HYDRATION_CONTROLLER_WITH_SHELL_IMAGE)
OCI_SYNC_GCR := gcr.io/$(GCR_PREFIX)/$(OCI_SYNC_IMAGE)
HELM_SYNC_GCR := gcr.io/$(GCR_PREFIX)/$(HELM_SYNC_IMAGE)
