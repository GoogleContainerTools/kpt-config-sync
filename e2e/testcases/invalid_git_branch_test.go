...
func TestInvalidRootSyncBranchStatus(t *testing.T) {
	...
	nt.Must(nt.WaitForRootSyncSourceError(configsync.RootSyncName, status.SourceErrorCode, ""))
...
func TestInvalidRepoSyncBranchStatus(t *testing.T) {
	...
	nt.Must(nt.WaitForRepoSyncSourceError(namespaceRepo, configsync.RepoSyncName, status.SourceErrorCode, ""))
