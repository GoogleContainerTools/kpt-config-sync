...
func TestConflictingDefinitions_RootToNamespace(t *testing.T) {
	...
	nt.Must(nt.WaitForRepoSyncSyncError(repoSyncKey.Namespace, repoSyncKey.Name, status.ManagementConflictErrorCode, "detected a management conflict", nil))
...
func TestConflictingDefinitions_NamespaceToNamespace(t *testing.T) {
	...
	nt.Must(nt.WaitForRepoSyncSyncError(repoSync2Key.Namespace, repoSync2Key.Name, status.ManagementConflictErrorCode, "detected a management conflict", nil))
