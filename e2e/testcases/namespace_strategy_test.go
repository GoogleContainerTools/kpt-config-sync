...
func TestNamespaceStrategy(t *testing.T) {
	...
	// check for error
	nt.Must(nt.WaitForRootSyncSyncError(rootSyncNN.Name, applier.ApplierErrorCode,
...
func TestNamespaceStrategyMultipleRootSyncs(t *testing.T) {
	...
	// check for error
	nt.Must(nt.WaitForRootSyncSyncError(rootSyncX.Name, applier.ApplierErrorCode,
		"failed to apply ConfigMap, namespace-a/cm-x: namespaces \"namespace-a\" not found", nil))
	nt.Must(nt.WaitForRootSyncSyncError(rootSyncY.Name, applier.ApplierErrorCode,
