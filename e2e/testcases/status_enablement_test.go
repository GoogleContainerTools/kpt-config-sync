...
func resourceGroupHasNoStatus(obj client.Object) error {
	...
	// observedGeneration & observedGenerations might still be populated when
	// status is disabled. So check emptiness by ignoring them.
	...
	emptyStatus := resourcegroupv1alpha1.ResourceGroupStatus{
		...
		ObservedGenerations: *rg.Status.ObservedGenerations.DeepCopy(),
	}
...
func resourceGroupHasStatus(obj client.Object) error {
	...
	// observedGeneration & observedGenerations might still be populated when
	// status is disabled. So check non-emptiness by ignoring them.
	emptyStatus := resourcegroupv1alpha1.ResourceGroupStatus{
		ObservedGeneration:  rg.Status.ObservedGeneration,
		ObservedGenerations: *rg.Status.ObservedGenerations.DeepCopy(),
	}
