...
func TestMultiDependencies(t *testing.T) {
	...
	nt.Must(nt.WaitForRootSyncSyncError(configsync.RootSyncName, applier.ApplierErrorCode, "cyclic dependency", nil))
...
func TestExternalDependencyError(t *testing.T) {
	...
	nt.Must(nt.WaitForRootSyncSyncError(configsync.RootSyncName, applier.ApplierErrorCode, "dependency", nil))
	...
	nt.Must(nt.WaitForRootSyncSyncError(configsync.RootSyncName, applier.ApplierErrorCode, "external dependency", nil))
...
func TestDependencyWithReconciliation(t *testing.T) {
	...
	nt.Must(nt.WaitForRootSyncSyncError(configsync.RootSyncName, applier.ApplierErrorCode,
