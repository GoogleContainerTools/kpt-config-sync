...
This document is a guide on how to install Config Sync on a kubernetes cluster.
...
Note: Set the kubectl context in your shell to the desired cluster before proceeding.
