...
func (in *HelmBase) DeepCopyInto(out *HelmBase) {
	*out = *in
	...
	if in.ValuesFileSources != nil {
		in, out := &in.ValuesFileSources, &out.ValuesFileSources
		*out = make([]ValuesFileSources, len(*in))
		copy(*out, *in)
	}
	out.Period = in.Period
	if in.SecretRef != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ValuesFileSources) DeepCopyInto(out *ValuesFileSources) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ValuesFileSources.
func (in *ValuesFileSources) DeepCopy() *ValuesFileSources {
	if in == nil {
		return nil
	}
	out := new(ValuesFileSources)
	in.DeepCopyInto(out)
	return out
}
