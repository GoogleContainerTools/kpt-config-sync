...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RoleRefBase) DeepCopyInto(out *RoleRefBase) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RoleRefBase.
func (in *RoleRefBase) DeepCopy() *RoleRefBase {
	if in == nil {
		return nil
	}
	out := new(RoleRefBase)
...
func (in *RootSyncRoleRef) DeepCopyInto(out *RootSyncRoleRef) {
	*out = *in
	out.RoleRefBase = in.RoleRefBase
}
