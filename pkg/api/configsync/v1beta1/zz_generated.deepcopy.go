...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NotificationError) DeepCopyInto(out *NotificationError) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NotificationError.
func (in *NotificationError) DeepCopy() *NotificationError {
	if in == nil {
		return nil
	}
	out := new(NotificationError)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NotificationStatus) DeepCopyInto(out *NotificationStatus) {
	*out = *in
	...
	if in.Errors != nil {
		...
		*out = make([]NotificationError, len(*in))
		copy(*out, *in)
	}
	if in.Warnings != nil {
