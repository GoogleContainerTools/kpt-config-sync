...
func (in *HelmBase) DeepCopyInto(out *HelmBase) {
	*out = *in
	...
	if in.ValuesFileRefs != nil {
		...
		*out = make([]ValuesFileRefs, len(*in))
		copy(*out, *in)
	}
	out.Period = in.Period
	if in.SecretRef != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ValuesFileRefs) DeepCopyInto(out *ValuesFileRefs) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ValuesFileRefs.
func (in *ValuesFileRefs) DeepCopy() *ValuesFileRefs {
	if in == nil {
		return nil
	}
	out := new(ValuesFileRefs)
	in.DeepCopyInto(out)
	return out
}
