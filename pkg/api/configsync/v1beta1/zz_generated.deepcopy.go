...
func (in *ClusterRoleOverrideSpec) DeepCopyInto(out *ClusterRoleOverrideSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterRoleOverrideSpec.
func (in *ClusterRoleOverrideSpec) DeepCopy() *ClusterRoleOverrideSpec {
	if in == nil {
		return nil
	}
	out := new(ClusterRoleOverrideSpec)
	in.DeepCopyInto(out)
	return out
}
