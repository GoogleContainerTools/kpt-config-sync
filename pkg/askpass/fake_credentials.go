...
type FakeCredentialProvider struct {
	...
	CredentialsOut auth.TokenProvider
...
func (p *FakeCredentialProvider) Credentials() (auth.TokenProvider, error) {
...
func (p *FakeTokenProvider) Token(_ context.Context) (*auth.Token, error) {
