...
type ConfigsyncV1alpha1Interface interface {
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ConfigsyncV1alpha1Client, error) {
	...
	return &ConfigsyncV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ConfigsyncV1alpha1Client for the given config and
...
func New(c rest.Interface) *ConfigsyncV1alpha1Client {
	return &ConfigsyncV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) error {
	gv := configsyncv1alpha1.SchemeGroupVersion
