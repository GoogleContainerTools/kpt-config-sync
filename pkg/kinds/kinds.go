...
func ResourceGroup() schema.GroupVersionKind {
	return resourcegroupv1alpha1.SchemeGroupVersion.WithKind("ResourceGroup")
}
...
// HorizontalPodAutoscaler returns the canonical HorizontalPodAutoscaler GroupVersionKind.
