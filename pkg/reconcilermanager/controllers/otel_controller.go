...
func NewOtelReconciler(client client.Client, log logr.Logger, scheme *runtime.Scheme, credentialProvider askpass.CredentialProvider) *OtelReconciler {
...
func (r *OtelReconciler) configureGooglecloudConfigMap(ctx context.Context) ([]byte, error) {
	...
	if err != nil {
		if askpass.IsCredentialsNotFoundError(err) {
