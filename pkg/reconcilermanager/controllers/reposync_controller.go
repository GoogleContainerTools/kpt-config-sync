...
func (r *RepoSyncReconciler) updateStatus(ctx context.Context, lastSeen, rs *v1beta1.RepoSync) error {
	...
	// RepoSync struct field nillable or converting to Unstructured.
	// Patch should be good enough here because the reconciler-manager should be
	// the only controller modifying RepoSync status.
