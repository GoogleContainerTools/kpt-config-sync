...
func TestRootSyncReconcileWithInvalidCACertSecret(t *testing.T) {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			rootsync.SetStalled(wantRs, "Validation", validate.MissingKeyInSecret(fmt.Sprintf("caCertSecretRef was set, but %s key is not present in %s Secret", CACertSecretKey, caCertSecret)))
