	...
	testCases := map[string]struct {
		...
		"with inline values": {
			...
			expected: []corev1.EnvVar{
				...
				{Name: reconcilermanager.HelmValuesKeyMergeMode, Value: "override"},
			},
		},
		"without inline values": {
			...
			expected: []corev1.EnvVar{
				...
				{Name: reconcilermanager.HelmSyncWait, Value: "15.000000"},
				{Name: reconcilermanager.HelmSyncVersionPollingPeriod, Value: "1h"},
				{Name: reconcilermanager.HelmValuesKeyMergeMode, Value: "merge"},
			},
		},
	}
