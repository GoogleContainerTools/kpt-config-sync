...
func (s *Scoper) AddCustomResources(crds []*v1.CustomResourceDefinition) {
...
func scopesFromCRDs(crds []*v1.CustomResourceDefinition) []GroupKindScope {
	var result []GroupKindScope
...
func isServed(crd *v1.CustomResourceDefinition) bool {
...
func scopeFromCRD(crd *v1.CustomResourceDefinition) GroupKindScope {
	// CRD Scope defaults to Namespaced
	scope := NamespaceScope
	if crd.Spec.Scope == v1.ClusterScoped {
		scope = ClusterScope
	}
