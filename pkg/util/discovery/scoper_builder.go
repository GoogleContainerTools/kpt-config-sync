...
type BuildScoperFunc func([]*apiextensionsv1.CustomResourceDefinition, []ast.FileObject) (Scoper, status.MultiError)
...
func ScoperBuilder(sr ServerResourcer, addFuncs ...AddResourcesFunc) BuildScoperFunc {
	return func(crds []*apiextensionsv1.CustomResourceDefinition, objs []ast.FileObject) (Scoper, status.MultiError) {
