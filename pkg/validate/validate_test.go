	...
	testCases := []struct {
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.Namespace("namespaces/foo",
					...
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:spec":{},"f:status":{}}`),
				...
				fake.RoleAtPath("namespaces/foo/role.yaml",
					core.Namespace("foo"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:rules":{}}`),
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.FileObject(crdUnstructured(t, kinds.Anvil(),
					...
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:spec":{"f:group":{},"f:names":{"f:kind":{},"f:plural":{}},"f:scope":{},"f:versions":{}},"f:status":{"f:acceptedNames":{"f:kind":{},"f:plural":{}},"f:conditions":{},"f:storedVersions":{}}}`),
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.ClusterRoleAtPath("cluster/prod-admin_cr.yaml",
					core.Name("prod-admin"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{"f:configmanagement.gke.io/cluster-selector":{}}},"f:rules":{}}`),
				...
				fake.ClusterRoleAtPath("cluster/prod-owner_cr.yaml",
					core.Name("prod-owner"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{"f:configsync.gke.io/cluster-name-selector":{}}},"f:rules":{}}`),
					core.Annotation(csmetadata.ClusterNameAnnotationKey, "prod"),
					core.Annotation(csmetadata.ClusterNameSelectorAnnotationKey, "prod"),
					core.Annotation(csmetadata.SourcePathAnnotationKey, dir+"/cluster/prod-owner_cr.yaml")),
				fake.Namespace("namespaces/bookstore",
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{"f:configsync.gke.io/cluster-name-selector":{}}},"f:spec":{},"f:status":{}}`),
					core.Annotation(csmetadata.ClusterNameAnnotationKey, "prod"),
					core.Annotation(csmetadata.ClusterNameSelectorAnnotationKey, "prod"),
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.Namespace("namespaces/bar/prod-ns",
					core.Label("env", "prod"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:metadata":{"f:labels":{"f:env":{}}},"f:spec":{},"f:status":{}}`),
				...
				fake.RoleBindingAtPath("namespaces/bar/sre-rb.yaml",
					...
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{"f:configmanagement.gke.io/namespace-selector":{}}},"f:roleRef":{"f:apiGroup":{},"f:kind":{},"f:name":{}}}`),
					core.Annotation(csmetadata.NamespaceSelectorAnnotationKey, "sre-supported"),
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.ClusterRoleBindingAtPath("cluster/foo/crb.yaml",
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:roleRef":{"f:apiGroup":{},"f:kind":{},"f:name":{}}}`),
		...
		},
		{
			...
			want: []ast.FileObject{
				...
				validRepoSync("bookstore", "repo-sync-1", "namespaces/bookstore/rs.yaml",
					...
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:spec":{".":{},"f:git":{".":{},"f:auth":{},"f:period":{},"f:repo":{}},"f:sourceType":{}},"f:status":{".":{},"f:observedGeneration":{},"f:rendering":{".":{},"f:lastUpdate":{}},"f:source":{".":{},"f:lastUpdate":{}},"f:sync":{".":{},"f:lastUpdate":{}}}}`),
					core.Label(csmetadata.DeclaredVersionLabel, "v1beta1"),
				)},
		},
	}
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.Namespace("prod-shipping",
					core.Label("sre-supported", "true"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:metadata":{"f:labels":{"f:sre-supported":{}}},"f:spec":{},"f:status":{}}`),
					core.Annotation(csmetadata.SourcePathAnnotationKey, dir+"/prod-shipping/namespace.yaml")),
				fake.Namespace("dev-shipping",
					core.Label("dev-supported", "true"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:metadata":{"f:labels":{"f:dev-supported":{}}},"f:spec":{},"f:status":{}}`),
					core.Annotation(csmetadata.SourcePathAnnotationKey, dir+"/dev-shipping/namespace.yaml")),
				fake.RoleAtPath("sre-role.yaml",
					core.Name("role"),
					core.Namespace("prod-shipping"),
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{"f:configmanagement.gke.io/namespace-selector":{}}},"f:rules":{}}`),
					core.Annotation(csmetadata.NamespaceSelectorAnnotationKey, "sre"),
		...
		},
		{
			...
			want: []ast.FileObject{
				...
				fake.UnstructuredAtPath(
					...
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{".":{},"f:configmanagement.gke.io/managed":{}}}}`),
					core.Annotation(csmetadata.ResourceManagementKey, csmetadata.ResourceManagementDisabled),
