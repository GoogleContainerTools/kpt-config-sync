	...
	testCases := []struct {
		...
		},
		{
			...
			want: []ast.FileObject{
				...
				fake.RoleBindingAtPath("namespaces/bar/sre-rb.yaml",
					...
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{"f:configmanagement.gke.io/namespace-selector":{}},"f:labels":{}},"f:roleRef":{}}`),
					core.Annotation(csmetadata.NamespaceSelectorAnnotationKey, "sre-supported"),
		...
		},
		{
			...
			want: []ast.FileObject{
				fake.ClusterRoleBindingAtPath("cluster/foo/crb.yaml",
					core.Label(csmetadata.DeclaredVersionLabel, "v1"),
					core.Annotation(csmetadata.DeclaredFieldsKey, `{"f:metadata":{"f:annotations":{},"f:labels":{}},"f:roleRef":{}}`),
