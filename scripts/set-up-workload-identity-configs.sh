...
#
# Pre-requisite:
# 1. GCP_PROJECT and FLEET_HOST_PROJECT are set.
# 2. The FLEET_HOST_PROJECT project is created.
# 4. You have the permission to enable API service in the ${GCP_PROJECT} project.
# 5. You have permission to manage IAM service accounts and policies in both the ${GCP_PROJECT} project and the ${FLEET_HOST_PROJECT} project.
