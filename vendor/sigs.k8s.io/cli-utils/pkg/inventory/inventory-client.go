...
type ToUnstructuredFunc func(*unstructured.Unstructured, *UnstructuredInventory) (*unstructured.Unstructured, error)
...
// Updates the status if StatusPolicyAll is used
